export function FinalGoal() {
  return (
    <section className="border-b border-hairline py-20 lg:py-28">
      <div className="mx-auto flex max-w-4xl flex-col gap-10 px-5 lg:px-8">
        ...
        <div className="max-w-md rounded-3xl border border-hairline bg-surface p-8 shadow-lift print-block sm:p-10">
